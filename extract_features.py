...
def extract_features():
    ...
    src = '/home/sam/Music/cough/asr/training_data/yes/*wav'
    for file_name in glob.glob(os.path.join(src)):
        ...
        try:
            ...
            continue
        features_list.append([mfccs,'yes'])
    
    src = '/home/sam/Music/cough/asr/training_data/no/*wav'
    for file_name in glob.glob(os.path.join(src)):
        print("Extracting file ", file_name)
        try:
            mfccs = get_features(file_name)
